...
| Серия для соцсетей (TikTok / Reels / Shorts), повторяющийся герой, «контент с нуля» | `short-form-series.md` — **до STORY LOCK**; блок SERIES SCALE обязателен |
...
Для 6–15-секундной рекламы не строй CANON и паспорта — хватит STORY LOCK + биты + шоты. Для серии эпизодов или повторяющегося героя CANON и паспорта обязательны до первой сцены, а STORY LOCK содержит заполненный блок `SERIES SCALE` (`short-form-series.md`): движок без локации и времени, ≥3 оси вариативности, 10 названий эпизодов, ≥5 локаций, люди в кадре. Правило мира, которое запрещает менять место, время суток или собеседника, — не пишется.
...
- Серия = движок формата, не декорация. Консистентность героя держит PASSPORT §A и референс; мир обязан менять место, людей и ситуацию от эпизода к эпизоду. Тест серии из `short-form-series.md` — до логлайна.
