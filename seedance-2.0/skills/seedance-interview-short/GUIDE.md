...
Route to [seedance-sequence](../seedance-sequence/GUIDE.md) for connected clips, long scenes, unclear total duration, or continuation-ready planning; [seedance-continuation](../seedance-continuation/GUIDE.md) for accepted-footage continuation; [seedance-prompt](../seedance-prompt/GUIDE.md) for a full standalone production prompt; [seedance-prompt-short](../seedance-prompt-short/GUIDE.md) for a compact prompt; [seedance-copyright](../seedance-copyright/GUIDE.md) for IP/likeness risk; or [seedance-troubleshoot](../seedance-troubleshoot/GUIDE.md) when the user starts from a bad result.
