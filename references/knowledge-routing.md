...
## Живая база пользователя

Основная база:

`C:\Users\ganba\Documents\Obsidian Vault\ИИ Хранилище\Промты для генерации фото`

Считай ее актуальнее встроенных кратких правил. В начале задачи проверь доступность пути и прочитай заметки в UTF-8. Если база недоступна, продолжай по reference-файлам навыка и сообщи об этом одним предложением.

## Что читать

Всегда для нового креативного проекта:

- `00 · Карта — Промты для генерации фото.md`
- `09 · Стартовый протокол агента — фото и видео.md`
- `06 · Журнал · что работало.md` — только релевантные свежие записи.

Для генерации или редактирования фото:

- `01 · Анатомия идеального промта.md`
- `04 · Референсы (reference images).md`
- `05 · Камеры · Линзы · Плёнка.md`
- `02 · Nano Banana Pro (Gemini 3 Pro Image).md` или `03 · GPT Image (gpt-image-2).md` по выбранной модели.
...
- `02 · Nano Banana Pro (Gemini 3 Pro Image).md` в Obsidian — практика и подтверждённые тесты пользователя; при конфликте с общей документацией побеждает последний подтверждённый тест.
...
Для комнат, кухонь и environment board:

- `07 · Кейс · Torchin — кухни для рекламной раскадровки.md`
- `08 · Раскадровка комнат — рабочий процесс и шаблон.md`

Для видео:

- `10 · Видео — промпт, референсы и continuity.md`
- `11 · Креативный маршрут — сценарий, режиссура, VO.md`
...
- `12 · Seedance — 30-секундный ролик, тесты и continuity.md` — только как пользовательский журнал прошлых тестов; при конфликте с актуальной официальной инструкцией Seedance 2.5 следуй `references/seedance-2.5.md` и последнему подтвержденному тесту.
- `13 · Переходы между локациями — fixed camera и сборка декораций.md` для start/end frame, Kling, fixed-camera и смены локации.
...
Обновляй базу только после фактической проверки. Добавляй короткую запись в журнал либо в наиболее подходящую существующую заметку. Не создавай новую верхнеуровневую заметку, если подходящее место уже есть.
