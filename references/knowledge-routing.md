...
- `references/story-production-contract.md` — общий договор двух скиллов: область поручения и выдача, неизменность выбранного исходника, active/blocked/removed, сквозная сверка постановки/промпта/результата и зависимые версии. Определяет сохранение содержания независимо от модели.
